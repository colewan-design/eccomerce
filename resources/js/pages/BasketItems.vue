<template>
  ...
  >
	...
	<v-dialog v-model="modal_basket_item" transition="dialog-top-transition" scrollable persistent max-width="100%">
    <v-card>
  ...
  export default {
    ...
    methods: {
        ...
        Save() {
          if (this.id) {
            axios
              .put("/Basket_Items/basket-items-update/" +this.id, this.basket_items_crud)
              .then((response) => {
                this.BasketItems();
                this.close();
              })
            ...
            axios
              .post("/Basket_Items/basket-items-store", this.basket_items_crud)
              .then((response) => {
                this.BasketItems();
                this.close();
              })
